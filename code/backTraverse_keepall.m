function [time_pt,ind_pt,ancestor_times,ancestor_inds,all_prev_cell_times,all_prev_cell_inds] = backTraverse_keepall(start_time,start_ind,mode,time_parameter,embryo)
%same as backTraverse, but keeps times,indices of all
...
while counter > 0
    ...
    all_prev_cell_times = [all_prev_cell_times;time_pt];
    all_prev_cell_inds = [all_prev_cell_inds;ind_pt];
