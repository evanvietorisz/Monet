...
%aux--note: more useful scripts in the 'hyperparameterTuning2' underneath
...
default_param_values = {"radius_boundingsphere_celldensity",20;
                        ...
                        "k_intercelldistance",              20;
                        "degree_cousins",                   1;
                        "timewindow_migrationpaths",        0.0750;
                        "timewindow_migrationcongruency",   0.0750;
                        "k_migrationcongruency",            10};

param_ranges =         {"radius_boundingsphere_celldensity",[5:10:25];
                        "radius_boundingsphere_residual",   [5:10:25];
                        "radius_boundingsphere_nucsize",    [5:10:25];
...
optimization_cases_jun10 = cell(1);
...
for i = 1:size(param_ranges,1)
    ...
    for j = 1:length(param_ranges{i,2})
        ...
        optimization_cases_jun10{c,1} = feats;
        optimization_cases_jun10{c,2} = param_dummy;
...
save('optimization_cases_jun10.mat')
...
cases = load('optimization_cases_jun10.mat');
cases = cases.optimization_cases_jun10;

save_name = 'optimization_cases_jun10_WITHRESULTS';
...
for i = 1:size(cases,1)
    ...
    %try
        ...
        cases_output{i,6} = adjusted_percellfeature;
...
save('optimization_jun10_results_files.mat','baseline_percellfeature_normed','fate_percellfeature_normed','lineage_percellfeature_normed','baseline_reduced','fate_reduced','lineage_reduced','default_param_values','fate_param_values','lineage_param_values','-v7.3')


%%
%actually score the new plots
...
[fate_optimized_fate_score, fate_optimized_lineage_score] = computeScore3(fate_lowD_percellfeature,adjusted_embeddingStruct,embryo,number_neighbors,time_window,fate_condensed_lowD_percellfeature,fate_condensed_embeddingStruct,starttime,sampling,endtime);
...
[lineage_optimized_fate_score, lineage_optimized_lineage_score] = computeScore3(lineage_lowD_percellfeature,adjusted_embeddingStruct,embryo,number_neighbors,time_window,lineage_condensed_lowD_percellfeature,fate_condensed_embeddingStruct,starttime,sampling,endtime);
...
%%
%retrying with five neighbors because failed

new_num_neighbors = 5;
%jun 18 score the plots using five nns to see if a bug
...
[five_baseline_fate_score, five_baseline_lineage_score] = computeScore3(baseline_lowD_percellfeature,adjusted_embeddingStruct,embryo,new_num_neighbors,time_window,baseline_condensed_lowD_percellfeature,baseline_condensed_embeddingStruct,starttime,sampling,endtime);

%fate_lowD_percellfeature = run_umap(fate_percellfeature_normed,'n_components',15,'n_neighbors',neighborparam);
%[fate_condensed_lowD_percellfeature,fate_condensed_embeddingStruct] = condenseToOneEntryPerCell(fate_lowD_percellfeature,adjusted_embeddingStruct,'median_timepoint_entry');

[five_fate_fate_score, five_fate_lineage_score] = computeScore3(fate_lowD_percellfeature,adjusted_embeddingStruct,embryo,new_num_neighbors,time_window,fate_condensed_lowD_percellfeature,fate_condensed_embeddingStruct,starttime,sampling,endtime);

%lineage_lowD_percellfeature = run_umap(lineage_percellfeature_normed,'n_components',15,'n_neighbors',neighborparam);
%[lineage_condensed_lowD_percellfeature,lineage_condensed_embeddingStruct] = condenseToOneEntryPerCell(lineage_lowD_percellfeature,adjusted_embeddingStruct,'median_timepoint_entry');

[five_lineage_fate_score, five_lineage_lineage_score] = computeScore3(lineage_lowD_percellfeature,adjusted_embeddingStruct,embryo,new_num_neighbors,time_window,lineage_condensed_lowD_percellfeature,fate_condensed_embeddingStruct,starttime,sampling,endtime);
